...
foreach (['/api/servers/{server}/dayz', '/api/server/{server}/dayz'] as $prefix) {
    ...
    $routes[] = ['method' => 'GET',    'uri' => $prefix . '/player-actions/give-money/{id}/bridge-fulfil',  'action' => 'GamePanelMods\\DayZManager\\Controllers\\DayZPlayerController@bridgeFulfillGiveMoney'];
    $routes[] = ['method' => 'POST',   'uri' => $prefix . '/player-actions/give-money/{id}/bridge-fulfil',  'action' => 'GamePanelMods\\DayZManager\\Controllers\\DayZPlayerController@bridgeFulfillGiveMoney'];
